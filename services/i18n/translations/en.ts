...
const en = {
  ...
  community: {
    ...
    cardNothingShared: 'Not sharing any details yet.',
    ...
    socialsMissingTitle: 'Add your accounts first',
    socialsMissing:
      'You haven’t saved a Facebook or Instagram account yet. Add one in Account settings, then you can share it with the community.',
    socialsMissingAction: 'Account settings',
